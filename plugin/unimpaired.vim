...
call s:map('n', '[ot', ':set colorcolumn=80<CR>')
call s:map('n', ']ot', ':set colorcolumn=0<CR>')
call s:map('n', 'yot', ':set colorcolumn=<C-R>=&colorcolumn == 0 ? 80 : 0 <CR><CR>')
call s:map('n', '[of', ':let b:syntastic_skip_checks=0<CR>:SyntasticCheck<CR>')
call s:map('n', ']of', ':let b:syntastic_skip_checks=1<CR>:SyntasticReset<CR>')
call s:map('n', 'yof', ':let b:syntastic_skip_checks=<C-R>=(!exists("b:syntastic_skip_checks")) ? 0 : (b:syntastic_skip_checks == 1) ? 0 : 1 <CR><CR>:<C-R>=(b:syntastic_skip_checks) ? "SyntasticReset" : "SyntasticCheck"<CR><CR>')
